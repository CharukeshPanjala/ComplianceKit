...
const styles = {
  ...
  generateBtn: "px-4 py-2 text-sm font-medium border border-gray-200 rounded-xl text-gray-700 hover:border-[#0F2044] transition-colors disabled:opacity-50",
  exportBtn: "px-4 py-2 text-sm font-medium border border-gray-200 rounded-xl text-gray-700 hover:border-[#0F2044] transition-colors disabled:opacity-50",
  addBtn: "px-4 py-2 bg-[#0F2044] text-white text-sm font-semibold rounded-xl hover:bg-[#1a3366] transition-colors",
  table: "w-full border border-gray-100 rounded-xl overflow-hidden",
  ...
  activityName: "font-medium text-gray-900",
