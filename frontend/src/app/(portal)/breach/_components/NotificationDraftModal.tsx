...
const styles = {
  ...
  textarea: "w-full px-3 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-700 font-mono leading-relaxed resize-none focus:outline-none focus:ring-2 focus:ring-[#D97706]",
  footer: "px-6 py-4 border-t border-gray-100 flex justify-between items-center flex-shrink-0",
  copyBtn: "px-4 py-2 text-sm font-medium bg-[#D97706] hover:bg-[#B45309] text-white rounded-lg transition-colors",
